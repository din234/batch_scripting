...
nnoremap <F2> :bp <CR>
nnoremap <F3> :bn <CR>
nnoremap <F5> :w <BAR>:vnew debug.h <BAR> :1,%d <BAR> :.! g++ -g # && a.exe <CR>
"nnoremap <F5> :w <BAR>:vnew debug.h <BAR> :1,%d <BAR> :.! g++ -c api.cpp && g++ -o api api.o -lgdi32 <CR>"
nnoremap <F6> :w <BAR>:!cls && g++ -g % && a.exe <CR>